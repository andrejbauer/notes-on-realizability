...
\end{align*}
%
(Missing: verification that this really is a left adjoint.)
...
\end{align*}
%
(Missing: verification that this really is a right adjoint.)

It is customary to write $\xsome{y}{T}{q(x,y)}$ and
$\xall{y}{T}{q(x,y)}$ instead of $\exists_{\asm{T}} q$ and
$\forall_{\asm{T}} q$.

(Missing: the Beck-Chevalley condition and interaction between
quantifiers and substitutions.)
...
\overline{\asm{S}}$. A formula $\phi$ whose free variables are among
$x_1, \ldots, x_n$.
