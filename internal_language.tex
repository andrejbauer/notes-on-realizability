...
morphism $\zero \to \asm{S}$ for every assembly~$\asm{S}$.
...
Lastly, pushouts are dual to pullbacks. They exist in~$\AsmA$ because
every finite colimit is a coequalizer of a finite coproduct. We leave
an explicit description of pushouts as exercise.
