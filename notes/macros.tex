...
\newcommand{\Trunc}[1]{\left\|#1\right\|} % Propositional truncation
\newcommand{\trunc}[1]{|#1|}
...
\newcommand{\Ex}[1]{\mathsf{E}_{#1}}
\newcommand{\per}{\approx}

\newcommand{\entails}{\vdash}
\newcommand{\bientails}{\mathrel{{\dashv}{\vdash}}}

\newcommand{\typ}[2]{#1_{#2}}
\newcommand{\Atyp}[1]{\typ{\AA}{#1}}
\newcommand{\xAtyp}[1]{\typ{\AA}{\T{#1}}}
...
\newcommand{\PredT}[1]{\mathsf{Pred}'(#1)} % predicates a la subsingleton assemblies

%\newcommand{\subcat}[1]{\mathsf{Subset}(#1)}

\newcommand{\Set}{\mathsf{Set}}
\newcommand{\Fam}[2][]{\mathsf{Fam}_{#1}(#2)}
...
\newcommand{\iscontext}{\;\mathsf{type}}
\newcommand{\emptyCtx}{\one}
