...
\input{models.tex}            % Week 1, 2
\input{assemblies.tex}        % Week 3, 4, 5
\input{internal_language.tex} % Week 6, 7
\input{computable_spaces.tex} % Week 8, 9, 10, 11, 12, 13
\input{implementation.tex}    % Week 14, 15
