...
computation. These will turn out to be examples of a general notion of computation, the typed partial combinatory algebras.
...
\begin{proof}
  ...
  \end{equation*}
  %
  is realized. By \cref{th:G_delta_characteristic} there
  ...
  \end{equation*}
  % 
  By \cref{lemma:normalized-BB} we may assume that $\alpha$ and
