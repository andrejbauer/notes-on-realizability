...
\begin{exercise}
  The \defemph{empty assembly $\Zero$} has as its underlying set the empty set~$\emptyset$. Show that the choice of the underlying type does not matter and that the empty assembly is the initial object.
\end{exercise}
