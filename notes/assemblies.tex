...
A popular realizability model is Kleene's~\sidecite{KV65} \emph{function
...
\item
  ...
  name of \emph{domain representations}~\sidecite{Bla97,Bla97a}.
\item
