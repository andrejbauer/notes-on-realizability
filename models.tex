...
\begin{proof}
  ...
  machine is sitting right here on my desk.\footnote{You have to
    ...
    are really \emph{Von Neumann} machines~\cite{vonNeumann} because
...
can be easily confused with multiplication, a traditional notation for
this algebra is $\set{m}(n)$, but we shall not use it.
...
application is formed. What we need is the concept of \emph{typed
  PCA}, which was defined by John Longley.
...
\end{align*}
%
We usually omit the types in subscripts and write $x \, y$ for $x
\cdot_{s,t} y$. For all elements $x, y, z$ of appropriate types we
require:
%
\begin{align*}
  \combK \, x \, y &= x \\
...
Every PCA $A$ is a NR-TPCA with over the trivial type system
