...
%
  ...
  \noindent
  \texttt{lam[x{\char95}Symbol, x{\char95}Symbol] := s[k][k]}\\
  \texttt{lam[x{\char95}Symbol, y{\char95}Symbol] := k[y]}\\
  \texttt{lam[x{\char95}Symbol, f{\char95}[g{\char95}]] := s[lam[x,f]][lam[x,g]]}\\
  \texttt{lam[vars{\char95}List, f{\char95}] :=
    Fold[lam[{\char35}2,{\char35}1]{\char38}, f, Reverse[vars]]}
  \end{quotation}
  %
}
%
...
constructs in a PCA.
%
\index{combinator!pair@{$\combPair$, $\pair{\place, \place}$}}%
