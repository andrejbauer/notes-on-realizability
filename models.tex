...
proof of consistency of Peano arithmetic.
...
Note that the primitive recursion operator $\combPRec_t$ is expressible
as (where $s = t \to (\ttnat \to t \to t) \to \ttnat \to t$)
%
\begin{equation*}
  \combFix_s \, \xulam{\annot{r}{s}}{\xulam{(
    \annot{f}{\ttnat \to t \to t}
    \annot{n}{\ttnat}}{
    \cond{n = 0}{x}{f\,n\,(r\,x\,f\,(n-1))}}})
\end{equation*}
...
Warning about operational semantics.
