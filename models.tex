...
\ttnat$, and for each type~$s$, a constant $\combPRec_s$ of type $s
\to (\mathtt{nat} \to s \to s) \to \ttnat \to s$. We also add two
...
elements of $A_s$ are closed expressions of type~$s$, quotiented by
...
To obtain an example of a (total) NR-TPCA we enrich G\"
