...
rule is essentialy a directed version of $\beta$-reduction.
...
The reduction rules are \emph{deterministic}: for each $e$ there is at
most one~$e'$ such that $e \oneto e'$. The \emph{evaluation} of a
program~$e$ is the sequence of reductions $e \oneto e' \oneto e''
\oneto \cdots$ resulting from successive applications of reduction
rules.
