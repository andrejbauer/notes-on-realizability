...
A popular model is \emph{type 2} Turing machine. It is a machine which
accepts an infinite sequence, written on its input tape, and
eventually fills every cell on the output tape with a non-blank
symbol. Obviously such a machine does not terminate.
